...
# 0 Gy dose: Chao1 produced significant results but but Shannon showed no significance and observed was just bareley insignificant at 0.051
# 0.1 Gy dose: all three tests produced significant results of at least less than 0.005.
# 0.25 Gy dose: all thee tests had no significant results
# 1.0 Gy dose: all thee tests had no significant results
```
